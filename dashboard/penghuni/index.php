...
<body class="dashboard-body tw:p-0 tw:m-0 tw:relative tw:flex">
    ...
    <main class="tw:md:ml-75 tw:grow">
        <div class="tw:pt-20 tw:md:pt-5 tw:px-5 tw:mb-8 tw:flex-1 tw:w-dvw tw:md:w-full">
            ...
            <h1 class="page-title" data-kicker="Master Penghuni"
                data-subtitle="Pantau identitas penghuni, penempatan kamar, dan pengelolaan akun dengan tampilan yang lebih modern.">
                Kelola Penghuni
            </h1>
