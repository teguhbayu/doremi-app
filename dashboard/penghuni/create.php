...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ((int) $selectedKamar['JumlahPenghuniAktual'] >= (int) $selectedKamar['KapasitasPenghuni']) {
        header("Location: " . $_SERVER['PHP_SELF'] . '?status=error&message=Kamar yang dipilih sudah penuh!');
        exit;
    }
