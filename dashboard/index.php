...
if ($role === 'SIGAP') {
    $sigapStats = fetchDashboardSigapStats($db);
    $pendingConfirmation = $sigapStats['pendingConfirmation'];
    $currentlyOutside = $sigapStats['currentlyOutside'];
    $pendingPackagePickupSigap = $sigapStats['pendingPackagePickup'];
    $packagesToday = $sigapStats['packagesToday'];
}
    ...
    <main class="tw:md:ml-75 tw:grow tw:relative tw:z-10">
        <div class="tw:pt-20 tw:md:pt-8 tw:px-8 tw:mb-8 tw:flex-1 tw:w-dvw tw:md:w-full">
            ...
            <?php elseif ($role === 'SIGAP'): ?>
                <div class="tw:grid tw:grid-cols-1 tw:md:grid-cols-2 tw:lg:grid-cols-4 tw:gap-6 tw:mb-10">
                    <div data-gsap="stat-card"
                        class="tw:relative tw:items-center tw:flex tw:overflow-hidden tw:p-[1.4rem] tw:rounded-[28px] tw:border tw:border-[rgba(255,255,255,0.75)] tw:bg-[rgba(255,255,255,0.85)] tw:shadow-sm">
                        <div class="tw:flex tw:items-center tw:gap-4">
                            <div
                                class="tw:w-[3.4rem] tw:h-[3.4rem] tw:inline-flex tw:items-center tw:justify-center tw:rounded-[20px] tw:flex-shrink-0 tw:text-amber-700 tw:bg-[rgba(250,236,207,0.82)]">
                                <i class="iconsax tw:text-3xl" icon-name="clock"></i>
                            ...
                            <div>
                                <span
                                    class="tw:block tw:text-slate-500 tw:text-[0.72rem] tw:font-extrabold tw:tracking-[0.08em] tw:uppercase">Menunggu
                                    Konfirmasi</span>
                                <strong
                                    class="tw:block tw:mt-[0.3rem] tw:text-[1.9rem] tw:leading-none tw:text-slate-900 tw:font-bold"
                                    data-count="<?= $pendingConfirmation ?>">0</strong>
                            </div>
                        </div>
                    </div>
                    <div data-gsap="stat-card"
                        ...
                        <div class="tw:flex tw:items-center tw:gap-4">
                            ...
                            <div>
                                ...
                                <strong
                                    class="tw:block tw:mt-[0.3rem] tw:text-[1.9rem] tw:leading-none tw:text-slate-900 tw:font-bold"
                                    data-count="<?= $currentlyOutside ?>">0</strong>
                            </div>
                        </div>
                    </div>
                    <div data-gsap="stat-card"
                        class="tw:relative tw:overflow-hidden tw:items-center tw:flex tw:p-[1.4rem] tw:rounded-[28px] tw:border tw:border-[rgba(255,255,255,0.75)] tw:bg-[rgba(255,255,255,0.85)] tw:shadow-sm">
                        <div class="tw:flex tw:items-center tw:gap-4">
                            <div
                                class="tw:w-[3.4rem] tw:h-[3.4rem] tw:inline-flex tw:items-center tw:justify-center tw:rounded-[20px] tw:flex-shrink-0 tw:text-emerald-800 tw:bg-[rgba(220,244,239,0.82)]">
                                <i class="iconsax tw:text-3xl" icon-name="box-time"></i>
                            ...
                            <div>
                                ...
                                <strong
                                    class="tw:block tw:mt-[0.3rem] tw:text-[1.9rem] tw:leading-none tw:text-slate-900 tw:font-bold"
                                    data-count="<?= $pendingPackagePickupSigap ?>">0</strong>
                            </div>
                        </div>
                    </div>
                    <div data-gsap="stat-card"
                        ...
                        <div class="tw:flex tw:items-center tw:gap-4">
                            ...
                            <div>
                                <span
                                    class="tw:block tw:text-slate-500 tw:text-[0.72rem] tw:font-extrabold tw:tracking-[0.08em] tw:uppercase">Paket
                                    Tercatat Hari Ini</span>
                                <strong
                                    class="tw:block tw:mt-[0.3rem] tw:text-[1.9rem] tw:leading-none tw:text-slate-900 tw:font-bold"
                                    data-count="<?= $packagesToday ?>">0</strong>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php elseif ($role === 'SIGAP'): ?>
                <div class="tw:grid tw:grid-cols-1 tw:lg:grid-cols-2 tw:gap-8">
                    <div data-gsap="panel"
                        ...
                        <p class="tw:m-0 tw:text-slate-500 tw:leading-[1.75] tw:text-sm tw:mb-4">Pantau permintaan izin
                            keluar
                            penghuni yang menunggu konfirmasi dan yang masih berada di luar asrama.</p>
                        <div class="tw:grid tw:gap-[0.85rem]">
                            <div
                                class="tw:p-4 tw:rounded-[18px] tw:bg-[rgba(255,255,255,0.80)] tw:border tw:border-[rgba(22,60,122,0.08)]">
                                <span class="tw:block tw:mb-[0.3rem] tw:text-slate-500 tw:text-xs tw:font-bold">Menunggu
                                    konfirmasi</span>
                            ...
                            <div
                                class="tw:p-4 tw:rounded-[18px] tw:bg-[rgba(255,255,255,0.80)] tw:border tw:border-[rgba(22,60,122,0.08)]">
                                <span class="tw:block tw:mb-[0.3rem] tw:text-slate-500 tw:text-xs tw:font-bold">Sedang di
                                    luar</span>
                    ...
                    <div data-gsap="panel"
                        class="tw:relative tw:overflow-hidden tw:p-[1.4rem] tw:rounded-[28px] tw:border tw:border-[rgba(255,255,255,0.75)] tw:bg-[rgba(255,255,255,0.88)] tw:shadow-sm">
                        <h5 class="tw:m-0 tw:text-[1.2rem] tw:text-slate-900">Ringkasan Paket</h5>
                        <p class="tw:m-0 tw:text-slate-500 tw:leading-[1.75] tw:text-sm tw:mb-4">Lihat paket yang masih
                            menunggu
                            diambil penghuni dan aktivitas pencatatan paket hari ini.</p>
                        <div class="tw:grid tw:gap-[0.85rem]">
                            <div
                                class="tw:p-4 tw:rounded-[18px] tw:bg-[rgba(255,255,255,0.80)] tw:border tw:border-[rgba(22,60,122,0.08)]">
                                <span class="tw:block tw:mb-[0.3rem] tw:text-slate-500 tw:text-xs tw:font-bold">Belum
                            ...
                            <div
                                class="tw:p-4 tw:rounded-[18px] tw:bg-[rgba(255,255,255,0.80)] tw:border tw:border-[rgba(22,60,122,0.08)]">
                                <span class="tw:block tw:mb-[0.3rem] tw:text-slate-500 tw:text-xs tw:font-bold">Tercatat
                                    hari ini</span>
