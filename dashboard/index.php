...
<body class="tw:p-0 tw:m-0 relative tw:flex tw:bg-[#f8fafc] tw:min-h-screen tw:overflow-x-hidden">
    ...
    <main class="tw:ml-75 tw:grow tw:relative tw:z-10">
        <div class="tw:pt-8 tw:px-8 tw:flex-1 tw:w-full">
            ...
            <?php if ($role === 'PENGURUS'): ?>
                <div class="tw:grid tw:grid-cols-1 md:tw:grid-cols-2 lg:tw:grid-cols-4 tw:gap-6 tw:mb-10">
                    <!-- Stat Card 1 -->
                    <div
                        class="tw:group tw:relative tw:bg-white/60 tw:backdrop-blur-xl tw:p-6 tw:rounded-[24px] tw:border tw:border-white tw:shadow-[0_8px_30px_rgb(0,0,0,0.04)] tw:transition-all tw:duration-500 hover:tw:shadow-[0_20px_50px_rgba(59,130,246,0.1)] hover:tw:-translate-y-1">
                        <div class="tw:flex tw:items-center tw:gap-5">
                            <div
                                class="tw:p-4 tw:bg-blue-500/10 tw:text-blue-600 tw:rounded-[18px] tw:transition-colors tw:duration-500 group-hover:tw:bg-blue-500 group-hover:tw:text-white">
                    ...
                    <!-- Stat Card 2 -->
                    <div
                        class="tw:group tw:relative tw:bg-white/60 tw:backdrop-blur-xl tw:p-6 tw:rounded-[24px] tw:border tw:border-white tw:shadow-[0_8px_30px_rgb(0,0,0,0.04)] tw:transition-all tw:duration-500 hover:tw:shadow-[0_20px_50px_rgba(34,197,94,0.1)] hover:tw:-translate-y-1">
                        <div class="tw:flex tw:items-center tw:gap-5">
                            <div
                                class="tw:p-4 tw:bg-green-500/10 tw:text-green-600 tw:rounded-[18px] tw:transition-colors tw:duration-500 group-hover:tw:bg-green-500 group-hover:tw:text-white">
                    ...
                    <!-- Stat Card 3 -->
                    <div
                        class="tw:group tw:relative tw:bg-white/60 tw:backdrop-blur-xl tw:p-6 tw:rounded-[24px] tw:border tw:border-white tw:shadow-[0_8px_30px_rgb(0,0,0,0.04)] tw:transition-all tw:duration-500 hover:tw:shadow-[0_20px_50px_rgba(168,85,247,0.1)] hover:tw:-translate-y-1">
                        <div class="tw:flex tw:items-center tw:gap-5">
                            <div
                                class="tw:p-4 tw:bg-purple-500/10 tw:text-purple-600 tw:rounded-[18px] tw:transition-colors tw:duration-500 group-hover:tw:bg-purple-500 group-hover:tw:text-white">
                    ...
                    <!-- Stat Card 4 -->
                    <div
                        class="tw:group tw:relative tw:bg-white/60 tw:backdrop-blur-xl tw:p-6 tw:rounded-[24px] tw:border tw:border-white tw:shadow-[0_8px_30px_rgb(0,0,0,0.04)] tw:transition-all tw:duration-500 hover:tw:shadow-[0_20px_50px_rgba(249,115,22,0.1)] hover:tw:-translate-y-1">
                        <div class="tw:flex tw:items-center tw:gap-5">
                            <div
                                class="tw:p-4 tw:bg-orange-500/10 tw:text-orange-600 tw:rounded-[18px] tw:transition-colors tw:duration-500 group-hover:tw:bg-orange-500 group-hover:tw:text-white">
