...
<body class="dashboard-body tw:p-0 tw:m-0 tw:relative tw:flex">
    ...
    <main class="tw:md:ml-75 tw:grow">
        <div class="tw:pt-20 tw:md:pt-5 tw:px-5 tw:mb-8 tw:flex-1 tw:w-dvw tw:md:w-full">
            ...
            <form method="POST" class="tw:grid tw:grid-cols-1 tw:lg:grid-cols-2 tw:gap-4 tw:max-w-[980px] tw:p-[1.45rem] tw:rounded-[24px] tw:border tw:border-[rgba(255,255,255,0.75)] tw:bg-[rgba(255,255,255,0.88)] tw:shadow-sm" x-data='<?= json_encode($formData, JSON_HEX_APOS | JSON_HEX_QUOT) ?>'>
                <div class="mb-3">
