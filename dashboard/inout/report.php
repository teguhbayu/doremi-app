...
if (isset($_GET['export']) && $_GET['export'] === 'pdf') {
    ...
    \Utils\generateReportPdf($filename, 'Laporan Izin Keluar Masuk', $rangeLabelFull, $headers, $widths, $rows, $charts);
    exit;
}
...
<body class="dashboard-body tw:p-0 tw:m-0 tw:relative tw:flex tw:min-h-screen tw:overflow-x-hidden">
    ...
    <script>
        window.reportChartSpecs = [
            { id: 'chartStatus', title: 'Distribusi Status Izin' },
            { id: 'chartTrend', title: 'Trend Izin Keluar' },
            { id: 'chartHour', title: 'Jam Sibuk Keluar' },
            { id: 'chartPenghuni', title: 'Top 5 Penghuni Paling Sering Keluar' },
            { id: 'chartGender', title: 'Distribusi Jenis Kelamin' },
