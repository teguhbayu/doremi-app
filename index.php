    ...
    <div class="tw-pt-16 tw-flex-1 tw-h-full tw-w-full tw-relative tw-overflow-y-auto tw-overflow-x-hidden">
        <div id="landing-container" class="tw-min-h-full tw-flex tw-flex-col">
            <section
                ...
                <div
                    class="tw-max-w-7xl tw-mx-auto tw-px-4 sm:tw-px-6 lg:tw-px-8 tw-relative tw-z-10 tw-py-16 sm:tw-py-24">
                    <div class="tw-text-center">
                        <h1
                            class="tw-text-4xl tw-tracking-tight tw-font-extrabold tw-text-gray-900 sm:tw-text-5xl md:tw-text-6xl">
                        ...
                        <p
                            class="tw-mt-3 tw-max-w-md tw-mx-auto tw-text-base tw-text-gray-500 sm:tw-text-lg md:tw-mt-5 md:tw-text-xl md:tw-max-w-3xl">
                        ...
                        <div
                            class="tw-mt-8 tw-no-underline tw-max-w-md tw-mx-auto sm:tw-flex sm:tw-justify-center md:tw-mt-10 tw-gap-4">
                            <a href="login.php"
                                class="tw-w-full tw-no-underline tw-flex tw-items-center tw-justify-center tw-px-8 tw-py-3 tw-border tw-border-transparent tw-text-base tw-font-medium tw-rounded-full tw-text-white tw-bg-primary hover:tw-bg-opacity-90 md:tw-py-4 md:tw-text-lg md:tw-px-10 tw-shadow-lg tw-transform tw-transition hover:-tw-translate-y-1">
                                Masuk Sistem
                            </a>
                            <a href="gallery.php"
                                class="tw-mt-3 tw-no-underline tw-w-full tw-flex tw-items-center tw-justify-center tw-px-8 tw-py-3 tw-border-2 tw-border-secondary tw-text-base tw-font-medium tw-rounded-full tw-text-primary tw-bg-transparent hover:tw-bg-secondary hover:tw-text-white md:tw-py-4 md:tw-text-lg md:tw-px-10 tw-mt-0 sm:tw-mt-0 tw-transition-colors">
                                Lihat Galeri
                            </a>
                        </div>
                    </div>
            ...
            <section class="tw-py-16 tw-bg-white tw-z-10 tw-relative">
                <div class="tw-max-w-7xl tw-mx-auto tw-px-4 sm:tw-px-6 lg:tw-px-8">
                    ...
                    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-8">
                        <div
                            class="tw-p-6 tw-bg-background tw-rounded-2xl tw-border tw-border-accent/30 hover:tw-shadow-xl tw-transition-shadow">
                            <div
