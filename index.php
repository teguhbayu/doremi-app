...
<body class="public-body">
    ...
    <div class="public-main tw:pt-16 tw:flex-1 tw:h-full tw:w-full tw:relative tw:overflow-y-auto tw:overflow-x-hidden">
        <div id="landing-container" class="tw:min-h-full tw:flex tw:flex-col">
            <section
                class="public-hero-section tw:relative tw:bg-background tw:overflow-hidden tw:flex-1 tw:flex tw:flex-col tw:justify-center">
                ...
                <div
                    class="public-hero__content tw:max-w-7xl tw:mx-auto tw:px-4 tw:sm:px-6 tw:lg:px-8 tw:relative tw:z-10 tw:py-16 tw:sm:py-24">
                    <div class="tw:text-center">
                        <h1
                            class="public-display tw:text-4xl tw:tracking-tight tw:font-extrabold tw:text-gray-900 tw:sm:text-5xl tw:md:text-6xl">
                        ...
                        <p
                            class="public-lead tw:mt-3 tw:max-w-md tw:mx-auto tw:text-base tw:text-gray-500 tw:sm:text-lg tw:md:mt-5 tw:md:text-xl tw:md:max-w-3xl">
            ...
            <section class="public-feature-section tw:py-16 tw:bg-white tw:z-10 tw:relative">
                <div class="tw:max-w-7xl tw:mx-auto tw:px-4 tw:sm:px-6 tw:lg:px-8">
                    <div class="public-section-heading tw:text-center tw:mb-12">
                    ...
                    <div class="public-feature-grid tw:grid tw:grid-cols-1 tw:md:grid-cols-3 tw:gap-8">
                        <div
                            class="public-feature-card tw:p-6 tw:bg-background tw:rounded-2xl tw:border tw:border-accent/30 tw:hover:shadow-xl tw:transition-shadow">
                            <div
                                class="public-feature-icon public-feature-icon--soft tw:w-12 tw:h-12 tw:inline-flex tw:items-center tw:justify-center tw:rounded-xl tw:bg-accent tw:text-primary tw:mb-5">
                        ...
                        <div
                            class="public-feature-card tw:p-6 tw:bg-background tw:rounded-2xl tw:border tw:border-accent/30 tw:hover:shadow-xl tw:transition-shadow">
                            <div
                                class="public-feature-icon public-feature-icon--solid tw:w-12 tw:h-12 tw:inline-flex tw:items-center tw:justify-center tw:rounded-xl tw:bg-secondary tw:text-white tw:mb-5">
                        ...
                        <div
                            class="public-feature-card tw:p-6 tw:bg-background tw:rounded-2xl tw:border tw:border-accent/30 tw:hover:shadow-xl tw:transition-shadow">
                            <div
                                class="public-feature-icon public-feature-icon--dark tw:w-12 tw:h-12 tw:inline-flex tw:items-center tw:justify-center tw:rounded-xl tw:bg-primary tw:text-white tw:mb-5">
